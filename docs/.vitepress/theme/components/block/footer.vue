  ...
  <footer>
    <div class="content">
      ...
      <div class="footer-content">
        <div class="content-list" v-for="contentItem in footerContent" :key="contentItem">
      ...
      <div class="footer-bottom">
        ...
        <div class="copyright">Copyright © BFChain, All Rights Reserved. BFChain开发者社区 版权所有</div>
      </div>
    </div>
  </footer>
</template>
